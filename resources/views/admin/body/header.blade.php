        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <span class="fw-medium d-block">{{ $adminData->name }}</span>
                                    <small class="text-muted">{{ $adminData->role }}</small>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="dropdown-item" href="{{route('AdminLogout')}}" target="_blank">
                            <i style="color: red;" class="mdi mdi-logout me-2"></i>
                            <span class="align-middle" style="color: red;">Log Out</span>
                        </a>
                    </li>
                </ul>
            </li>
